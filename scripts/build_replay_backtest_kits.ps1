...
$backtestItems = @(
    @{ Source = "scripts\backtest_nifty_trend.py"; Target = "scripts\backtest_nifty_trend.py" },
    @{ Source = "scripts\optimize_nifty_trend.py"; Target = "scripts\optimize_nifty_trend.py" },
    @{ Source = "packages\trading_core"; Target = "packages\trading_core" },
    @{ Source = "config\.env"; Target = "config\.env"; Optional = $true },
