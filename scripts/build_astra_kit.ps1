...
$copyItems = @(
    ...
    @{ Source = "config\strategy_runtime.paper_replay.json.example"; Target = "config\strategy_runtime.paper_replay.json.example" },
    @{ Source = "config\strategy_runtime.paper_live.json.example"; Target = "config\strategy_runtime.paper_live.json.example" },
    @{ Source = "config\strategy_runtime.nifty_trend_options.live_broker.json.example"; Target = "config\strategy_runtime.nifty_trend_options.live_broker.json.example"; Optional = $true },
    @{ Source = "config\strategy_runtime.nifty_trend_options.live_collector_sse.json.example"; Target = "config\strategy_runtime.nifty_trend_options.live_collector_sse.json.example"; Optional = $true },
    @{ Source = "config\strategy_runtime.nifty_trend_options.live_live.broker.json.example"; Target = "config\strategy_runtime.nifty_trend_options.live_live.broker.json.example"; Optional = $true },
    @{ Source = "config\strategy_runtime.nifty_trend_options.live_live.collector_sse.json.example"; Target = "config\strategy_runtime.nifty_trend_options.live_live.collector_sse.json.example"; Optional = $true },
    @{ Source = "config\strategy_runtime.nifty_trend_options.live_paper.broker.json.example"; Target = "config\strategy_runtime.nifty_trend_options.live_paper.broker.json.example"; Optional = $true },
    @{ Source = "config\strategy_runtime.nifty_trend_options.live_paper.collector_sse.json.example"; Target = "config\strategy_runtime.nifty_trend_options.live_paper.collector_sse.json.example"; Optional = $true },
    @{ Source = "config\strategy_runtime.nifty_trend_options.replay_bars.json.example"; Target = "config\strategy_runtime.nifty_trend_options.replay_bars.json.example"; Optional = $true },
    @{ Source = "config\strategy_runtime.nifty_trend_options.replay_ticks.json.example"; Target = "config\strategy_runtime.nifty_trend_options.replay_ticks.json.example"; Optional = $true },
    @{ Source = "config\strategy_runtime.nifty_trend_options.backtest_bars.json.example"; Target = "config\strategy_runtime.nifty_trend_options.backtest_bars.json.example"; Optional = $true },
    @{ Source = "config\strategy_runtime.nifty_trend_options.backtest_ticks_partial.json.example"; Target = "config\strategy_runtime.nifty_trend_options.backtest_ticks_partial.json.example"; Optional = $true },
    @{ Source = "config\strategy_runtime.nifty_trend_options.backtest_ticks_full.json.example"; Target = "config\strategy_runtime.nifty_trend_options.backtest_ticks_full.json.example"; Optional = $true },
    @{ Source = "config\strategy_runtime.nifty_trend_options.optimize_bars.json.example"; Target = "config\strategy_runtime.nifty_trend_options.optimize_bars.json.example"; Optional = $true },
    @{ Source = "config\strategy_runtime.nifty_trend_options.optimize_ticks.json.example"; Target = "config\strategy_runtime.nifty_trend_options.optimize_ticks.json.example"; Optional = $true },
    @{ Source = "config\strategy_runtime.paper_live.json"; Target = "config\strategy_runtime.paper_live.json"; Optional = $true },
    @{ Source = "config\strategy_runtime.paper_replay.json"; Target = "config\strategy_runtime.paper_replay.json"; Optional = $true },
    @{ Source = "config\strategy_runtime.ema_cross.paper_replay.json"; Target = "config\strategy_runtime.ema_cross.paper_replay.json"; Optional = $true },
    ...
    @{ Source = "scripts\start_live_capture_and_strategy.ps1"; Target = "scripts\start_live_capture_and_strategy.ps1" },
