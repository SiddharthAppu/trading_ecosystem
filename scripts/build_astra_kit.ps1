...
$copyItems = @(
    ...
    @{ Source = "config\strategy_runtime.nifty_trend_options.live_broker.env.example"; Target = "config\strategy_runtime.nifty_trend_options.live_broker.env.example"; Optional = $true },
    @{ Source = "config\strategy_runtime.nifty_trend_options.live_collector_sse.env.example"; Target = "config\strategy_runtime.nifty_trend_options.live_collector_sse.env.example"; Optional = $true },
    @{ Source = "config\strategy_runtime.nifty_trend_options.replay_bars.env.example"; Target = "config\strategy_runtime.nifty_trend_options.replay_bars.env.example"; Optional = $true },
    @{ Source = "config\strategy_runtime.nifty_trend_options.replay_ticks.env.example"; Target = "config\strategy_runtime.nifty_trend_options.replay_ticks.env.example"; Optional = $true },
    @{ Source = "config\strategy_runtime.nifty_trend_options.backtest_bars.env.example"; Target = "config\strategy_runtime.nifty_trend_options.backtest_bars.env.example"; Optional = $true },
    @{ Source = "config\strategy_runtime.nifty_trend_options.backtest_ticks_partial.env.example"; Target = "config\strategy_runtime.nifty_trend_options.backtest_ticks_partial.env.example"; Optional = $true },
    @{ Source = "config\strategy_runtime.nifty_trend_options.backtest_ticks_full.env.example"; Target = "config\strategy_runtime.nifty_trend_options.backtest_ticks_full.env.example"; Optional = $true },
    @{ Source = "config\strategy_runtime.nifty_trend_options.optimize_bars.env.example"; Target = "config\strategy_runtime.nifty_trend_options.optimize_bars.env.example"; Optional = $true },
    @{ Source = "config\strategy_runtime.nifty_trend_options.optimize_ticks.env.example"; Target = "config\strategy_runtime.nifty_trend_options.optimize_ticks.env.example"; Optional = $true },
